...
const About = () => {
  return (
    <div>
      <div className='text-3xl text-center pt-8 border-t border-[#6D4C3D]'>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        <div className='border border-[#6D4C3D] px-10 md:px-12 py-8 sm:py-16 flex flex-col gap-5'>
          ...
          <p className='text-slate-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium veniam libero nihil ab aliquam veritatis. Exercitationem accusamus maiores, nostrum praesentium mollitia ad est modi debitis nam perspiciatis voluptates ab quibusdam.</p>
        </div>
        <div className='border border-[#6D4C3D] px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Convenience:</b>
          <p className='text-slate-600'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illo, consequatur. Est, laborum? In, ipsam illo repudiandae ducimus, eum magnam porro omnis praesentium fugit aut, eveniet at consequuntur dignissimos vel officiis.</p>
        </div>
        <div className='border border-[#6D4C3D] px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
          <b>Exceptional Customer Service:</b>
          <p className='text-slate-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet, dicta quia rem ullam quaerat consectetur nemo, porro, accusamus explicabo qui laborum veniam! Debitis architecto beatae, cupiditate laborum laudantium odit earum.</p>
        </div>
      </div>
