      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={()=>setMethod('debit/credit')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'debit/credit' ? 'bg-blue-400' : ''}`}></p>
              <img src={assets.visa} className='h-3 ml-4'/>
              <img src={assets.mastercard} className='h-4'/>
              <p className='text-gray-500 text-sm font-medium'>DEBIT / CREDIT CARD</p>
            </div>
          </div>
