              ...
              <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                <div>
                  <p className="sm:text-base font-semibold">
                    Order # <br /> <span className="font-normal text-gray-600">{order.confirmationCode}</span>
                  </p>
                ...
                <p className="sm:text-base font-semibold">
                  Payment: <span className="font-normal text-gray-600">{order.paymentMethod}</span>
                </p>
                <p className="sm:text-base font-semibold">
